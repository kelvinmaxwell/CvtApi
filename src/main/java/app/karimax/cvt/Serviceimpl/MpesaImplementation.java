...
//		 HttpEntity request = new HttpEntity(headers);
        ...
        if (response.getBody().getResponseCode().equalsIgnoreCase("0")) {
            ...
            if (savedInvoices != null) {
                ...
                invoices.setAmount(Double.valueOf(Prequest.getAmount()));
                invoices.setJob_card_id(Long.valueOf(Prequest.getJobcard()));
            ...
            if (ResultCode.equalsIgnoreCase("0")) {
                ...
                if (mpesaPayments != null) {
                    ...
                    if (mpesaPayments != null) {
                        ...
                        Job_Card_Service jService = jobCardRepository.findByJobCard(jcard.getId());
    ...
    public JobCard getjobByID(long id) {
        JobCard jobstatus = jobCardRepository.findByJobCardId(id);
